...
TOP_FEATURES_PATH = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'models', 'top_features.json')
COMPARISON_PATH = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'models', 'comparison.json')

# Train models on cold start
